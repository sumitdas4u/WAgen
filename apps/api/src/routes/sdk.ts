...
const CHATBOT_BUNDLE_JS = `(function () {
  ...
  var apiBase = apiBaseAttr || (new URL(scriptTag.src)).origin;
  ...
  if (document.getElementById("wagenai-widget-root")) return;
  ...
  var sendMessage = function () {
    ...
    if (!socket || socket.readyState !== 1) {
      push("Connecting... please send again.", "ai");
      return;
    }
