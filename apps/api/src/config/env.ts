...
const BaseEnvSchema = z.object({
  ...
  API_WORKERS_ENABLED: z.enum(["true", "false"]).default("true"),
  ...
  QUEUE_PREFIX: z.string().default("wagen"),
  ...
  SUPABASE_INBOUND_MEDIA_BUCKET: z.string().default("uploads"),
  ...
  DELIVERY_API_DOWNTIME_FAILURE_THRESHOLD: z.coerce.number().int().positive().default(3),
  DELIVERY_WEBHOOK_DELAY_SECONDS: z.coerce.number().int().positive().default(300),
  DELIVERY_RETRY_SWEEP_INTERVAL_SECONDS: z.coerce.number().int().positive().default(60),
...
export const env = {
  ...
  API_WORKERS_ENABLED: parsed.data.API_WORKERS_ENABLED === "true",
