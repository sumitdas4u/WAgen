...
export type WSEvent =
  ...
  | WSEnvelope<"message.updated", { messageId: string; conversationId: string; deliveryStatus: "pending" | "sent" | "delivered" | "read" | "failed"; errorCode?: string; errorMessage?: string; retryCount?: number }>
